        ...
        <div class="container">
            <div class="table-wrapper">
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        <c:if test="${tag1 > 1}">
                            <li class="page-item disabled"><a href="manager?index=${tag1-1}">Previous</a></li>
                        </c:if>
                        <c:forEach begin="1" end="${endP}" var="i">
                            <li class="page-item ${tag1 == i?"active":""}"><a href="manager?index=${i}" class="page-link">${i}</a></li>
                        </c:forEach>
                        <c:if test="${tag1<endP}">
                            <li class="page-item"><a href="manager?index=${tag1+1}" class="page-link">Next</a></li>
                        </c:if>
